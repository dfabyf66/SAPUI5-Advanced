		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee",
									"targetURL": "#dffspaceEmpemployee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dffspaceEmpemployee-display": {
								"semanticObject": "dffspaceEmpemployee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dffspaceEmp.employee",
									"url": sap.ui.require.toUrl("dffspaceEmp/employee")
								}
							}
						}
					}
