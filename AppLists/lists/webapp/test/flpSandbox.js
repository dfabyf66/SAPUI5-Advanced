		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "lists",
									"targetURL": "#dffspaceEmplists-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dffspaceEmplists-display": {
								"semanticObject": "dffspaceEmplists",
								"action": "display",
								"description": "Tipos de Listas",
								"title": "lists",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dffspaceEmp.lists",
									"url": sap.ui.require.toUrl("dffspaceEmp/lists")
								}
							}
						}
					}
